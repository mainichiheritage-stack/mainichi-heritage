...
import { Globe, Mail, Github, Twitter , Landmark } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="col-span-1 md:col-span-1 space-y-2">
            <div className="flex items-center gap-2 text-slate-900 font-black text-xl">
              ...
              <div className="flex flex-col sm:flex-row sm:items-baseline sm:gap-2">
                <span className="text-xl font-bold tracking-tight text-slate-800">まいにち世界遺産</span>
              </div>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-slate-600">
              <li><Link href="/heritages" className="hover:text-blue-600 transition-colors">世界遺産データベース</Link></li>
              <li><Link href="/quiz" className="hover:text-blue-600 transition-colors">4択クイズ</Link></li>
          ...
          {/* サポート/情報 */}
          <div>
            <h3 className="font-bold text-slate-900 mb-4">インフォメーション</h3>
            <ul className="space-y-2 text-sm text-slate-600">
              ...
              <li><Link href="/license" className="hover:text-blue-600 transition-colors">ライセンス・権利表記</Link></li>
              <li><Link href="https://forms.gle/nydMBWr1UyAXJZ3a6" className="hover:text-blue-600 transition-colors" target="_blank" rel="noopener noreferrer" >お問い合わせ</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex gap-4">
              ...
              <ul className="space-y-2 text-sm text-slate-600">
              <li><Link href="/" className="hover:text-blue-600 transition-colors">（準備中）</Link></li>
            </ul>
            </div>
          </div>
        </div>
