    ...
    <div className="min-h-screen bg-slate-50 py-16 px-6">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <h1 className="text-3xl font-bold text-slate-900 mb-4">ライセンス・権利表記</h1>
        ...
        <div className="space-y-8">
          ...
          <section className="bg-white rounded-2xl p-8 shadow-sm border border-slate-200">
            ...
            <div className="space-y-4 text-sm text-slate-600 leading-relaxed">
              <p>
                「世界遺産検定」および関連するロゴ・名称は、特定非営利活動法人 世界遺産アカデミーの登録商標です。
              </p>
              <div className="p-5 bg-amber-50 rounded-2xl border border-amber-100">
                <p className="text-amber-900 font-bold mb-1">【重要】非公式サービスである旨の通知</p>
                <p className="text-amber-800">
                  当プラットフォームは個人開発による<strong>非公式の学習支援ツール</strong>であり、世界遺産アカデミーおよび関連団体との資本関係、提携関係、または公認を受けたものではありません。
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="bg-white rounded-2xl p-8 shadow-sm border border-slate-200">
            ...
            <div className="space-y-6 text-sm text-slate-600 leading-relaxed">
              <div>
                <h3 className="font-bold text-slate-800 mb-2">■ Creative Commons (CC BY-SA)</h3>
                <p>
                  Wikipediaおよびウィキメディア・コモンズから提供される画像は、クリエイティブ・コモンズ 表示-継承ライセンス（CC BY-SA）に基づき利用しています。各画像の詳細ページに記載された著作者情報を尊重し、適切にクレジットを表示しています。
                </p>
              </div>
              ...
              <div>
                ...
                <p>
                  Unsplashから提供される画像は、Unsplash Licenseに基づき利用しています。著作者の表示義務はありませんが、素晴らしい作品を提供してくださるフォトグラファーへの敬意を表し、可能な限りクレジットを併記しています。
                </p>
              </div>
